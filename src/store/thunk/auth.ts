...
import type { LoginErrorResponse, LoginResponse, User } from '../../types/auth/auth.model';
import type { AxiosError } from 'axios';
import type { ShippingAddress } from '../../types/cart/cart-response.model';

const loginThunk = createAsyncThunk<LoginResponse, LoginPayload, { rejectValue: string }>(
  'auth/login',
...
const getProfileThunk = createAsyncThunk<User, undefined, { rejectValue: string }>(
  'auth/profile',
